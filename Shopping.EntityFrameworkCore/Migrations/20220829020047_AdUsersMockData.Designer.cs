...
namespace Shopping.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220829020047_AdUsersMockData")]
    partial class AdUsersMockData
    {
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9bd9d62a-68e5-41f1-8d17-429e5c38bfc3"),
                        ...
                        new
                        {
                            Id = new Guid("4f4b4b42-bfa9-48f4-a3f0-c05edd74834d"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("08a33569-aee5-446f-84e2-0784a17b493c"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Apple Macbook",
                            Price = 2400m
                        },
                        new
                        {
                            Id = new Guid("40d246d7-607c-40aa-8886-dc73b6b7a1c7"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Logitech Mouse",
                            Price = 80m
                        },
                        new
                        {
                            Id = new Guid("cd9ca704-a689-40bd-8781-44ccfef93426"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("696252e2-bedb-4b6f-8f0f-b5b561ce4c9c"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c5dc4442-9361-46fb-87ae-19c5f4b10f43"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@mail.com",
                            FirstName = "Teoman",
                            LastName = "Tıngır",
                            PasswordHash = "$2a$11$.MRL6qywoYpnruxA.Uo0deFr/2Psjh.JJI.9cesCtACteNkpEt836"
                        });
                });
